...
export class CommentsService {
  ...
  return this.httpClient.put(environment.baseUrl + `/posts/${postId}/comments/${commentId}`, formData);
}
...
createReply(postId: string, commentId: string, formData: FormData): Observable<any> {
  return this.httpClient.post(environment.baseUrl + `/posts/${postId}/comments/${commentId}/replies`, formData);
}
}
